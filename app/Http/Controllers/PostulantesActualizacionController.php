...
class PostulantesActualizacionController extends Controller
{
    //
    ...
    {
        $title="Lista de Postulantes de Proyectos de Actualización";
        $project = Project::find($id);
        $postulantes = ProjectHasPostulantes::where('project_id',$id)->get();
        //Mapper::map(-24.3697635, -56.5912129, ['zoom' => 6, 'type' => 'ROADMAP']);
        return view('postulantesactualizacion.index',compact('project','title','postulantes'));
        //return "hola";
    }
    ...
    public function create(Request $request, $id){
        ...
        $title="Agregar Postulante";
        return view('postulantesactualizacion.create',compact('title'));
    }
            ...
            if($book->success == true){
                ...
                if(isset($datospersona->obtenerPersonaPorNroCedulaResponse->return->error)){
                    ...
                    $idpostulante = $request->postulante_id;
                        //var_dump($datospersona->obtenerPersonaPorNroCedulaResponse);
                    return view('postulantesactualizacion.ficha.createmiembro',compact('nroexp','cedula','nombre','apellido','fecha','sexo',
    ...
    public function storemiembro(Request $request)
    {
        ...
        //return $request->all();
        //Postulante ::create($request->all());
        return redirect('actualizacion/'.$request->project_id.'/postulantes/'.$request->postulante_id)->with('success', 'Se ha agregado un nuevo Miembro!');
        //return $request;
    }
    ...
    public function show($id,$idpostulante)
    {
        ...
        return view('postulantesactualizacion.show',compact('title','project','miembros','documentos','docproyecto','postulante'));
    }
    ...
    public function edit($id,$idpostulante)
    {
        ...
        return view('postulantesactualizacion.create',compact('title','project','postulante','apellido','cedula','sexo','project_id',
    ...
    public function editmiembro($id,$idpostulante)
    {
        ...
        return view('postulantesactualizacion.ficha.createmiembro',compact('title','project','postulante','apellido','cedula','sexo','project_id',
    ...
    public function update(Request $request)
    {
        ...
        return redirect('actualizacion/'.$request->input("project_id").'/postulantes')->with('success', 'El postulante fue actualizado!');
    }
    ...
    public function updatemiembro(Request $request)
    {
        ...
        return redirect('actualizacion/'.$request->input("project_id").'/postulantes/'.$request->input("postulante_id"))->with('success', 'El miembro fue actualizado!');
    }
