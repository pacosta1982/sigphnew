          ...
          <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="address" value="{{ old('localidad',isset($project['localidad'])?$project['localidad']:'') }}" placeholder="Ingrese Dirección">
                        {!! $errors->first('address','<span class="help-block">:message</span>') !!}
                    </div>
                    <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                        <label for="exampleInputPassword1">Telefono (Linea Baja)</label>
                        <input type="text" class="form-control" name="phone" value="{{ old('phone',isset($project['phone'])?$project['phone']:'') }}" placeholder="Ingrese telefono">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('asentamiento') ? 'has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="ingreso" value="{{ old('ingreso',isset($project['ingreso'])?$project['ingreso']:'') }}" placeholder="Ingrese el Ingreso Mensual">
                        {!! $errors->first('ingreso','<span class="help-block">:message</span>') !!}
                    </div>

                    <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                        <label for="exampleInputPassword1">Telefono Movil (Celular)</label>
                        <input type="text" class="form-control" name="mobile" value="{{ old('mobile',isset($project['mobile'])?$project['mobile']:'') }}" placeholder="Ingrese Telefono Movil (Celular)">
