...
<div class="box box-primary">
    <form role="form" action="{{isset($postulante['id'])?action('PostulantesController@update',['id' => $postulante['id']]):action('PostulantesController@store') }}" method="post">
            @csrf
          ...
          <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('birthdate') ? 'has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="birthdate" value="{{ date('Y-M-d H:i:s', substr(strtotime($fecha), 0, 10) ) }}"  readonly>
